...
export function AIDecisionPanel() {
  ...
  const filteredPredictions = predictions.filter((pred) => {
    ...
    const matchesStatus =
      statusFilter === "all" || pred.status === statusFilter;
  ...
  const getActionMessage = (
    ...
    const messages: Record<string, { title: string; message: string }> = {
      ...
      create_order: {
        title: "Create Order",
        message: `Order Draft\n\nProduct: ${product.productName}\nSKU: ${product.sku}\nOrder Qty: ${product.reorderQuantity} units\n\nThis order will be prepared for approval.`,
      },
      schedule_reorder: {
      ...
      review_stock: {
        ...
        message: `Dead Stock Review\n\nProduct: ${product.productName}\nSKU: ${product.sku}\nCurrent Stock: ${product.currentStock} units\n\nThis product shows minimal movement. Consider clearance pricing.`,
      },
      create_promotion: {
  ...
  const modalContent = getActionMessage(
    actionModal.action,
    actionModal.product,
  );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          ...
          {
            key: "upcoming",
            value: summary.upcomingReorders,
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="text-center">
                      ...
                      <p
                        className={cn(
                          ...
                          pred.currentStock === 0
                            ? "text-red-400"
                            : pred.currentStock < pred.safeStockLevel
                              ? "text-amber-400"
                              : "text-foreground",
                        )}
                      >
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        handleAction(actions.primary.action, pred)
                      }
                    >
                          ...
                          {actions.secondary.map((action) => {
                            ...
                            return (
                              <DropdownMenuItem
                                key={action.action}
                                onClick={() =>
                                  handleAction(action.action, pred)
                                }
