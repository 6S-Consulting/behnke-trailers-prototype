...
export function TubeTilt20KDetails() {
  const [activeImage, setActiveImage] = useState(
    tubeTilt20K.gallery[0],
  );
  ...
  const handleDownloadBrochure = () => {
    ...
    pdf.setFontSize(22);
    pdf.text(tubeTilt20K.title, 40, 52);

    pdf.setFont("helvetica", "normal");
    pdf.setFontSize(11);
    const descriptionLines = pdf.splitTextToSize(
      tubeTilt20K.description,
      532,
    );
    ...
    pdf.setFont("helvetica", "normal");
    pdf.setFontSize(10);
    tubeTilt20K.specs.forEach((spec) => {
      if (y > 740) {
        pdf.addPage();
        y = 50;
      }
    ...
    pdf.setFont("helvetica", "normal");
    pdf.setFontSize(10);
    tubeTilt20K.details.forEach((detail) => {
      if (y > 740) {
        pdf.addPage();
        y = 50;
      }
    ...
    pdf.save(tubeTilt20K.brochureFileName);
  };
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  <Link
                    to="/trailers/20k-hd-tube-tilt/3d"
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                {tubeTilt20K.specs.slice(10).map((spec, idx) => (
                  <motion.div
                    key={spec.label}
                    initial={{ opacity: 0, x: -10 }}
                    whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            <ul className="space-y-2 text-muted-foreground">
              {tubeTilt20K.details.map((item, idx) => (
                <motion.li
                  key={item}
                  initial={{ opacity: 0, x: -10 }}
                  whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {tubeTilt20K.keyAdvantages.map((adv, idx) => (
                <motion.div
                  key={adv}
